...
def test_convert_db_to_json(app_config):
    """
...
@pytest.mark.usefixtures("setup_and_teardown")
def test_convert_db_to_csv(app_config):
    """
    ...
    file_path = os.path.join(app_config['FETCHER_FOLDER'], 'data', 'articles.csv')
...
def test_convert_db_to_parquet(app_config):
    ...
    file_path = os.path.join(app_config['FETCHER_FOLDER'], 'data', 'articles.parquet')
