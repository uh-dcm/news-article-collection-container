...
def setup_logging(app):
    """Logging handling for factory style app. Used by app.py."""
    # Setup log folder
    log_dir = os.path.abspath(os.path.join(app.config['FETCHER_FOLDER'], 'data', 'logs'))
